...
export declare const cameraKitFactory: {
    (args_0: LensRepository, args_1: MetricsEventTarget, args_2: LensCoreModule, args_3: Container<{
        ...
        (args_0: import("./configuration").CameraKitConfiguration, args_1: import("./metrics/operationalMetricsReporter").OperationalMetricsReporter): import("./remote-configuration/remoteConfiguration").RemoteConfiguration;
        token: "remoteConfiguration";
        dependencies: readonly ["configuration", "operationalMetricsReporter"];
    }, {
