...
export class RemoteConfiguration {
    constructor(apiToken, lensPerformance, reporter) {
        ...
        const cofHandler = cofHandlerFactory(apiToken, reporter);
...
export const remoteConfigurationFactory = Injectable("remoteConfiguration", [configurationToken, operationalMetricReporterFactory.token], (config, operationalMetricsReporter) => {
    const remoteConfig = new RemoteConfiguration(config.apiToken, config.lensPerformance, operationalMetricsReporter);
