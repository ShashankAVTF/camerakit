 ...
 */
export declare const cofHandlerFactory: (apiToken: string, reporter: OperationalMetricsReporter) => import("../handlers/HandlerChainBuilder").Handler<Partial<ConfigTargetingRequest>, ConfigTargetingResponse, Metadata & {
